...
module.spells.names = {
	...
	["damage"] = "Uszkodź Schody Nad Tobą",
	...
	["ghost"] = "Zduchuj schody Nad Tobą",
	["shadow"] = "Zduchuj Schody",
	["horizontal"] = "Teleport",
	...
	["spectrealtevent"] = "Królestwo Duchów",

	--HACKER
	["dash"] = "Teleport",
	["blink"] = "Wejdź w Schody",
	["swap"] = "Zmień",
	["slide"] = "Schody Ruchome",
	["slideup"] = "Zhakuj Schody",
	["glitch"] = "Wykonaj Błąd Schodów",

	["hack"] = "Speedhack",
	["hackerevent"] = "Armageddon Schodów Ruchomych",
	["hackeraltevent"] = "Wyłom",

	--THIEF
	["steal"] = "Ukradnij Schody",
	["stealabove"] = "Ukradnij Schody Nad Tobą",
	["place"] = "Postaw Schody",
	["uppass"] = "Postaw Schody Spiralne",
	["sidepass"] = "Stwórz Przejście",
	["drop"] = "Wyrzuć Schody",

	["heist"] = "Napad",
	["thiefevent"] = "Armageddon Wyrzucania Schodów",
	...
	["archonevent"] = "Brama-1",
	["archonaltevent"] = "Podzielenie",

	--DRIFTER
	["indrift"] = "Surfuj",
	["outdrift"] = "Losowy Drift",
	["updrift"] = "Winda",
	["diagdrift"] = "Przekątny Drift",
	["spin"] = "Obróć Schody",
	["driftabove"] = "Podnieś Schody nad Tobą",

	["riser"] = "Podnaszacz",
	["drifterevent"] = "Driftowanie",
	["drifteraltevent"] = "Podnoszenie",

	--HERETIC
	["createcursed"] = "Stwórz Przeklęte Schody",
	["curse"] = "Przeklnij Schody",
	["curseabove"] = "Przeklnij Schody Nad Tobą",
	["curseinter"] = "Przeklnij Intersekcję",
	["autodown"] = "Podniesiony Schizm",
	["autoup"] = "Obniżony Schizm",

	["malediction"] = "Złorzeczenie",
	["hereticevent"] = "Rozejście",
	["hereticaltevent"] = "Zemsta Heretyka",

	--SPLICER
	["twistup"] = "Zawiąż Schody Do Góry",
	["twistside"] = "Zawiąż Równoległe Schody",
	["twistrotate"] = "Zawiąż Schody Obok Siebie",
	["canceltwist"] = "Przywróć Zawiązane Schody",
	["split2"] = "Podziel Schody",
	["splitalt"] = "Podziel Schody Do Przodu",

	["twister"] = "Węzeł",
	["splicerevent"] = "Przeplatanie",
	["spliceraltevent"] = "Podzielenie",

	--NECROMANCER
	["createdual"] = "Stwórz Podwójne Schody",
	["copyplatform"] = "Zkopiuj Schody",
	["soulbridge"] = "Stwórz Duchowy Most",
	["undeadabove"] = "Zabierz Duszę Schodom",
	["revival"] = "Punkt Kontrolny",
	["regen"] = "Odzyskaj Manę",

	["duality"] = "Podwójność",
	["necromancerevent"] = "Przywracanie",
	["necromanceraltevent"] = "Zabieranie Dusz",

	--REAVER
	["createmirrored"] = "Stwórz Lustrzane Schody",
	["bigmirror"] = "Stwórz Duże Lustro",
	["smallmirror"] = "Stwórz Małe Lustro",
	["outermirror"] = "Stwórz Graniczne Lustro",
	["merge"] = "Połącz z Duchem",
	["oneway"] = "Stwórz Szklane Schody",

	["reflection"] = "Odbicie",
	["reaverevent"] = "Skrzyżowanie",
	["reaveraltevent"] = "Witryfikacja",


	--GREMLIN
	["tram"] = "Stwórz Tramwaj",
	["screwup"] = "Stwórz Górny Korkociąg",
	["revolve"] = "Okrąż Schody",
	["trapstairs"] = "Stwórz Schody Pułapkę",
	["screwdown"] = "Stwórz Dolny Korkociąg",
	["spinplatform"] = "Okrąż Platformę",

	["tramway"] = "Tram-Waj",
	["gremlinevent"] = "Rewolucja Obracania",
	["gremlinaltevent"] = "Generator Problemów",
	
	--TUTORIAL
	["tcreate"] = "Stwórz Schody",
	["tflip"] = "Wywróć Schody",
	["tdestroy"] = "Zniszcz Schody Nad Tobą",
	["tmove"] = "Rusz Schody",
	["tdash"] = "Teleport",
	["trestore"] = "Przywróć Schody",
